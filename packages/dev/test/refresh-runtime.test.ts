...
describe('ReactRefreshRuntime (Phase 19 Fast Refresh)', () => {
  ...
  it('compares hook signatures for compatibility', () => {
    ...
    function CounterV2() { return null; }
    function CounterWithDifferentHooks() { return null; }
    ...
    expect(ReactRefreshRuntime.areSignaturesCompatible(Counter, CounterWithDifferentHooks)).toBe(false);
  });
